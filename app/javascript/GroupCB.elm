        ...
        Nothing ->
            ...
            if caseval < 0x08 then
                let
                    ...
                    x =
                        { z80 | env = { env_1 | pc = raw.pc, time = raw.time } } |> set_flag_regs value.flags |> set408bit caseval value.value HL
                in
                Whole x
...
group_xy_cb ixiyhl rom48k z80 =
    let
        ...
        z80_2 =
            { z80_1 | env = { env_2 | pc = new_pc, time = c.time |> add_cpu_time_time 5 } }
