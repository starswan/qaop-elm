...
bit0indirectIx =
    List.range 0x40 0x47 |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_0 (z80_main.ix + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit1indirectIx =
    List.range 0x48 0x4F |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_1 (z80_main.ix + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit2indirectIx =
    List.range 0x50 0x57 |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_2 (z80_main.ix + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit3indirectIx =
    List.range 0x58 0x5F |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_3 (z80_main.ix + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit4indirectIx =
    List.range 0x60 0x67 |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_4 (z80_main.ix + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit5indirectIx =
    List.range 0x68 0x6F |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_5 (z80_main.ix + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit6indirectIx =
    List.range 0x70 0x77 |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_6 (z80_main.ix + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit7indirectIx =
    List.range 0x78 0x7F |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_7 (z80_main.ix + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList
...
bit0indirectIy =
    List.range 0x40 0x47 |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_0 (z80_main.iy + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit1indirectIy =
    List.range 0x48 0x4F |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_1 (z80_main.iy + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit2indirectIy =
    List.range 0x50 0x57 |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_2 (z80_main.iy + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit3indirectIy =
    List.range 0x58 0x5F |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_3 (z80_main.iy + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit4indirectIy =
    List.range 0x60 0x67 |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_4 (z80_main.iy + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit5indirectIy =
    List.range 0x68 0x6F |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_5 (z80_main.iy + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit6indirectIy =
    List.range 0x70 0x77 |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_6 (z80_main.iy + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList


bit7indirectIy =
    List.range 0x78 0x7F |> List.map (\index -> ( index, ( \z80_main offset rom48k z80_env -> bit_indirect Bit_7 (z80_main.iy + byte offset) rom48k z80_env, TwentyTStates ) )) |> Dict.fromList
...
singleByteMainRegsIXCB =
    Dict.fromList
        ...
        , ( 0x20, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeBRegister, TwentyThreeTStates ) )
        , ( 0x21, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeCRegister, TwentyThreeTStates ) )
        , ( 0x22, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeDRegister, TwentyThreeTStates ) )
        , ( 0x23, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeERegister, TwentyThreeTStates ) )
        , ( 0x24, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeHRegister, TwentyThreeTStates ) )
        , ( 0x25, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeLRegister, TwentyThreeTStates ) )
        , ( 0x26, ( \offset z80_main -> RegisterChangeShifter Shifter4 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF), FifteenTStates ) )
        , ( 0x28, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeBRegister, TwentyThreeTStates ) )
        , ( 0x29, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeCRegister, TwentyThreeTStates ) )
        , ( 0x2A, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeDRegister, TwentyThreeTStates ) )
        , ( 0x2B, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeERegister, TwentyThreeTStates ) )
        , ( 0x2C, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeHRegister, TwentyThreeTStates ) )
        , ( 0x2D, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeLRegister, TwentyThreeTStates ) )
        , ( 0x2E, ( \offset z80_main -> RegisterChangeShifter Shifter5 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF), FifteenTStates ) )
        , ( 0x30, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeBRegister, TwentyThreeTStates ) )
        , ( 0x31, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeCRegister, TwentyThreeTStates ) )
        , ( 0x32, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeDRegister, TwentyThreeTStates ) )
        , ( 0x33, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeERegister, TwentyThreeTStates ) )
        , ( 0x34, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.ix + byte offset) |> Bitwise.and 0xFFFF) ChangeHRegister, TwentyThreeTStates ) )
...
singleByteMainRegsIYCB =
    Dict.fromList
        ...
        , ( 0x20, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeBRegister, TwentyThreeTStates ) )
        , ( 0x21, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeCRegister, TwentyThreeTStates ) )
        , ( 0x22, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeDRegister, TwentyThreeTStates ) )
        , ( 0x23, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeERegister, TwentyThreeTStates ) )
        , ( 0x24, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeHRegister, TwentyThreeTStates ) )
        , ( 0x25, ( \offset z80_main -> RegisterIndirectWithShifter Shifter4 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeLRegister, TwentyThreeTStates ) )
        , ( 0x26, ( \offset z80_main -> RegisterChangeShifter Shifter4 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF), FifteenTStates ) )
        , ( 0x28, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeBRegister, TwentyThreeTStates ) )
        , ( 0x29, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeCRegister, TwentyThreeTStates ) )
        , ( 0x2A, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeDRegister, TwentyThreeTStates ) )
        , ( 0x2B, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeERegister, TwentyThreeTStates ) )
        , ( 0x2C, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeHRegister, TwentyThreeTStates ) )
        , ( 0x2D, ( \offset z80_main -> RegisterIndirectWithShifter Shifter5 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeLRegister, TwentyThreeTStates ) )
        , ( 0x2E, ( \offset z80_main -> RegisterChangeShifter Shifter5 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF), FifteenTStates ) )
        , ( 0x30, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeBRegister, TwentyThreeTStates ) )
        , ( 0x31, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeCRegister, TwentyThreeTStates ) )
        , ( 0x32, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeDRegister, TwentyThreeTStates ) )
        , ( 0x33, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeERegister, TwentyThreeTStates ) )
        , ( 0x34, ( \offset z80_main -> RegisterIndirectWithShifter Shifter6 ((z80_main.iy + byte offset) |> Bitwise.and 0xFFFF) ChangeHRegister, TwentyThreeTStates ) )
...
bit_indirect : BitTest -> Int -> Z80ROM -> Z80Env -> SingleEnvMainChange
bit_indirect bittest address rom48k z80_env =
    --case 0x40: bit(o, v); Ff=Ff&~F53 | a>>8&F53; return;
    let
        value =
            z80_env |> mem (address |> Bitwise.and 0xFFFF) z80_env.time rom48k
    in
