...
import Z80Types exposing (IXIY, IXIYHL(..), get_h_ixiy, get_l_ixiy, set_h, set_h_ixiy, set_l, set_l_ixiy)
...
ld_h_b : IXIY -> Z80ROM -> Z80Core -> Z80Delta
...
ld_h_c : IXIY -> Z80ROM -> Z80Core -> Z80Delta
...
ld_h_d : IXIY -> Z80ROM -> Z80Core -> Z80Delta
...
ld_h_e : IXIY -> Z80ROM -> Z80Core -> Z80Delta
...
ld_h_l : IXIY -> Z80ROM -> Z80Core -> Z80Delta
...
ld_l_b : IXIY -> Z80ROM -> Z80Core -> Z80Delta
...
ld_l_c : IXIY -> Z80ROM -> Z80Core -> Z80Delta
...
ld_l_d : IXIY -> Z80ROM -> Z80Core -> Z80Delta
...
ld_l_e : IXIY -> Z80ROM -> Z80Core -> Z80Delta
...
ld_l_h : IXIY -> Z80ROM -> Z80Core -> Z80Delta
