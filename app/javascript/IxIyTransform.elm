...
ixSingleByteMain =
    Dict.fromList
        ...
        , ( 0xDD84, \z80_main -> AddToRegisterA (z80_main.ix |> shiftRightBy8) )
        , ( 0xDD85, \z80_main -> AddToRegisterA (z80_main.ix |> Bitwise.and 0xFF) )

        -- case 0x8C: adc(xy>>>8); break;
        , ( 0xDD8C, \z80_main -> AdcRegisterA (z80_main.ix |> shiftRightBy8) )
        , ( 0xDD8D, \z80_main -> AdcRegisterA (z80_main.ix |> Bitwise.and 0xFF) )
        , ( 0xDD94, \z80_main -> SubRegisterA (z80_main.ix |> shiftRightBy8) )
        , ( 0xDD95, \z80_main -> SubRegisterA (z80_main.ix |> Bitwise.and 0xFF) )
        , ( 0xDD9C, \z80_main -> SbcRegisterA (z80_main.ix |> shiftRightBy8) )
        , ( 0xDD9D, \z80_main -> SbcRegisterA (z80_main.ix |> Bitwise.and 0xFF) )
        , ( 0xDDA4, \z80_main -> AndRegisterA (z80_main.ix |> shiftRightBy8) )
...
iySingleByteMain =
    Dict.fromList
        ...
        , ( 0xFD84, \z80_main -> AddToRegisterA (z80_main.iy |> shiftRightBy8) )
        , ( 0xFD85, \z80_main -> AddToRegisterA (z80_main.iy |> Bitwise.and 0xFF) )

        -- case 0x8C: adc(xy>>>8); break;
        , ( 0xFD8C, \z80_main -> AdcRegisterA (z80_main.iy |> shiftRightBy8) )
        , ( 0xFD8D, \z80_main -> AdcRegisterA (z80_main.iy |> Bitwise.and 0xFF) )
        , ( 0xFD94, \z80_main -> SubRegisterA (z80_main.iy |> shiftRightBy8) )
        , ( 0xFD95, \z80_main -> SubRegisterA (z80_main.iy |> Bitwise.and 0xFF) )
        , ( 0xFD9C, \z80_main -> SbcRegisterA (z80_main.iy |> shiftRightBy8) )
        , ( 0xFD9D, \z80_main -> SbcRegisterA (z80_main.iy |> Bitwise.and 0xFF) )
        , ( 0xFDA4, \z80_main -> AndRegisterA (z80_main.iy |> shiftRightBy8) )
