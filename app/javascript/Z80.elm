...
import SingleEnvWithMain exposing (parseSingleEnvMain)
import SingleMainWithFlags exposing (parseSingleByteMainAndFlags, singleByteMainAndFlagRegisters)
import SingleNoParams exposing (singleWithNoParam)
import TripleByte exposing (parseTriple16Param)
import TripleWithFlags exposing (parseTriple16Flags)
import TripleWithMain exposing (parseTripleMain)
...
import Z80Parser exposing (parseDoubleWithRegs, parseRelativeJump, parseSingleByteWithParam)
   ...
   case result of
       ...
       Nothing ->
          ...
          case doubler of
              ...
              Nothing ->
                  case parseSingleByteMainAndFlags instrTime instrCode z80 of
                      Just f -> Z80DeltaChange f
                      Nothing ->
