...
execute_0x96 ixiyhl rom48k z80 =
   ...
   let
       ...
       --env_1 = z80.env
   in
       --{ z80 | env = { env_1 | pc = value.pc, time = value.time } } |> set_flag_regs (z80_sub value.value z80.flags)
...
execute_0x9E ixiyhl rom48k z80 =
    ...
    let
       ...
       --env_1 = z80.env
    in
       --{ z80 | env = { env_1 | pc = value.pc, time = value.time } } |> set_flag_regs (sbc value.value z80.flags)
...
execute_0xBE ixiyhl rom48k z80 =
    ...
    let
       ...
       env_1 = z80.env
    in
       { z80 | env = { env_1 | pc = value.pc, time = value.time } } |> set_flag_regs (cp value.value z80.flags)
...
execute_0xE1 ixiyhl rom48k z80 =
   ...
   in
   case ixiyhl of
       IX -> MainRegsWithSpPcAndTime { main | ix = hl.value } hl.sp z80.env.pc hl.time
       IY -> MainRegsWithSpPcAndTime { main | iy = hl.value } hl.sp z80.env.pc hl.time
  ...
  in
    case ixiyhl of
      ...
      --HL -> { z80_2 | main = { main | hl = v.value } }
       IX -> MainRegsWithEnv { main | ix = hl.value } pushed
       IY -> MainRegsWithEnv { main | iy = hl.value } pushed
        ...
        in
            case ints.iM of
                ...
                3 -> let
                        ...
                        env1 = z80.env
                      in
                        { new_z80 | env = { env1 | time = env_and_pc.time, pc = env_and_pc.value } |> add_cpu_time_env 6 }
                _ -> new_z80
