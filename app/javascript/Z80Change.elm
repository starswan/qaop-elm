...
applyZ80Change : Z80Change -> InstructionLength -> CpuTimeCTime -> Z80Transform
applyZ80Change change new_pc cpu_time =
    case change of
        FlagsWithBRegister intWithFlags ->
            --let
            --    main =
        ...
        JustIXRegister int ->
            { pcIncrement = new_pc, time = cpu_time, timeIncrement = FourTStates, operation = ChangeMain (ChangeIXRegister int) }

        JustIYRegister int ->
            { pcIncrement = new_pc, time = cpu_time, timeIncrement = FourTStates, operation = ChangeMain (ChangeIYRegister int) }
