        ...
        NewAValue int ->
            let
                flags =
                    z80.flags
            in
            { z80 | pc = z80delta.pc, flags = { flags | a = int }, env = z80_env, interrupts = z80delta.interrupts }

        MainRegsWithCpuTime mainWithIndexRegisters cpuTimeCTime ->
            { z80 | pc = z80delta.pc, env = z80_env, main = mainWithIndexRegisters, interrupts = z80delta.interrupts }
