...
type Z80Delta
    ...
    | FlagRegsWithPc FlagRegisters Z80Address
    ...
    | SpAndCpuTimeWithPc Z80Address Int Z80Address
    ...
    | OnlyPush Z80Address
    | PushWithPc Z80Address Z80Address
    | PushWithCpuTimeAndPc Z80Address CpuTimeCTime Z80Address
    | PushWithMainSpCpuTimeAndPc Z80Address MainWithIndexRegisters Z80Address CpuTimeCTime Z80Address
    | PushWithMainSpCpuTime Z80Address MainWithIndexRegisters Z80Address CpuTimeCTime
...
applyDeltaWithChanges z80delta z80 =
    ...
    case z80delta.delta of
        ...
        SetImValue imvalue ->
            let
                interruptRegisters = z80.interrupts
            in
