...
singleByteFlags =
    Dict.fromList
        [ ( 0x07, ( rlca, FourTStates ) )
        , ( 0x0F, ( rrca, FourTStates ) )
        , ( 0x17, ( rla, FourTStates ) )
        , ( 0x1F, ( rra, FourTStates ) )
        , ( 0x27, ( z80_daa, FourTStates ) )
        , ( 0x2F, ( z80_cpl, FourTStates ) )
        , ( 0x37, ( scf, FourTStates ) )
        , ( 0x3C, ( inc_a, FourTStates ) )
        , ( 0x3D, ( dec_a, FourTStates ) )
        , ( 0x3F, ( ccf, FourTStates ) )
        , ( 0x47, ( ld_b_a, FourTStates ) )
        , ( 0x4F, ( ld_c_a, FourTStates ) )
        , ( 0x57, ( ld_d_a, FourTStates ) )
        , ( 0x5F, ( ld_e_a, FourTStates ) )
        , ( 0x67, ( ld_h_a, FourTStates ) )
        , ( 0x6F, ( ld_l_a, FourTStates ) )
        , ( 0x87, ( add_a_a, FourTStates ) )
        , ( 0x8F, ( adc_a_a, FourTStates ) )
        , ( 0x97, ( sub_a, FourTStates ) )
        , ( 0x9F, ( sbc_a, FourTStates ) )
        , ( 0xA7, ( and_a, FourTStates ) )
        , ( 0xAF, ( xor_a, FourTStates ) )
        , ( 0xB7, ( or_a, FourTStates ) )
        , ( 0xBF, ( cp_a, FourTStates ) )

        -- When item popped, z80_pop adds another 6 to make 11
        , ( 0xC0, ( ret_nz, FiveTStates ) )
        , ( 0xC8, ( ret_z, FiveTStates ) )
        , ( 0xD0, ( ret_nc, FiveTStates ) )
        , ( 0xD8, ( ret_c, FiveTStates ) )
        , ( 0xE0, ( ret_po, FiveTStates ) )
        , ( 0xE8, ( ret_pe, FiveTStates ) )
        , ( 0xF0, ( ret_p, FiveTStates ) )
        , ( 0xF5, ( push_af, ElevenTStates ) )
