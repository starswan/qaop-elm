...
ld_b_indirect_hl z80_main rom48k z80_env =
    ...
    SingleEnv8BitMain RegisterB value.value (value.time |> addCpuTimeTime 3)
...
ld_c_indirect_hl z80_main rom48k z80_env =
    ...
    SingleEnv8BitMain RegisterC value.value (value.time |> addCpuTimeTime 3)
...
ld_d_indirect_hl z80_main rom48k z80_env =
    ...
    SingleEnv8BitMain RegisterD value.value (value.time |> addCpuTimeTime 3)
...
ld_e_indirect_hl z80_main rom48k z80_env =
    ...
    SingleEnv8BitMain RegisterE value.value (value.time |> addCpuTimeTime 3)
