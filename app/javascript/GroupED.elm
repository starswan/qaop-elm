...
import Z80Core exposing (DirectionForLDIR(..), Z80Core, imm16)
...
execute_ED42 : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
execute_ED42 rom48k clockTime z80 =
    -- case 0x42: sbc_hl(B<<8|C); break;
    let
        bc =
            z80.main |> get_bc
    in
    z80 |> sbc_hl bc clockTime


execute_ED62 : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
execute_ED62 rom48k clockTime z80 =
    -- case 0x62: sbc_hl(HL); break;
    z80 |> sbc_hl z80.main.hl clockTime
...
execute_ED52 : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
execute_ED52 rom48k clockTime z80 =
    -- case 0x52: sbc_hl(D<<8|E); break;
    z80 |> sbc_hl (Bitwise.or (shiftLeftBy8 z80.main.d) z80.main.e) clockTime
...
execute_ED72 : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
execute_ED72 rom48k clockTime z80 =
    -- case 0x72: sbc_hl(SP); break;
    z80 |> sbc_hl z80.env.sp clockTime
...
execute_ED7B rom48k clockTime z80 =
    ...
    ( CpuTimeWithSpAndPc sp.value16 v.pc, sp.time |> addCpuTimeTime 6 )


ed_ldir : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
ed_ldir rom48k clockTime z80 =
    --0xB0 -> debug_log "LDIR" ("HL " ++ (z80.main.hl |> toHexString) ++ " BC " ++ (z80 |> get_bc |> toHexString2)) (z80 |> ldir 1 True)
    -- case 0xB0: ldir(1,true); break;
    z80 |> ldir Forwards True rom48k clockTime


ed_lddr : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
ed_lddr rom48k clockTime z80 =
    -- case 0xB8: ldir(-1,true); break;
    z80 |> ldir Backwards True rom48k clockTime


ed_cpdr : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
ed_cpdr rom48k clockTime z80 =
    -- case 0xB9: cpir(-1,true); break;
    z80 |> cpir Backwards True rom48k clockTime
...
group_ed rom48k clockTime z80_core =
    ...
    case ed_func of
        ...
        Nothing ->
            ...
            ( UnknownIntValue "group_ed" c.value, clockTime )
...
sbc_hl : Int -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
sbc_hl b clockTime z80 =
    let
        a =
            z80.main.hl
    ...
    ( FlagsWithPCMainAndCpuTime { flags | ff = ff, fa = fa, fb = fb, fr = fr } z80.pc { main | hl = r }, clockTime |> addCpuTimeTime 7 )
...
ldir : DirectionForLDIR -> Bool -> Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
ldir incOrDec repeat rom48k clockTime z80 =
    ...
    let
        ...
        flags =
            z80_2.flags
    in
    ( WholeCore { z80_2 | main = z80_2.main |> set_bc_main a, pc = pc, flags = { flags | fr = fr, ff = ff, fa = v, fb = v } }, clockTime |> addCpuTimeTime time )
...
cpir : DirectionForLDIR -> Bool -> Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
cpir incOrDec repeat rom48k clockTime z80_core =
    ...
    in
    ( HLBCWithFlagsAndPc hl new_bc { z80_flags | ff = ff, fa = new_fa, fb = new_fb, fr = fr } new_pc, b.time )
...
ed_ldi : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
ed_ldi rom48k clockTime z80 =
    -- case 0xA0: ldir(1,false); break;
    z80 |> ldir Forwards False rom48k clockTime


ed_cpi : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
ed_cpi rom48k clockTime z80 =
    -- case 0xA1: cpir(1,false); break;
    z80 |> cpir Forwards False rom48k clockTime


ed_ldd : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
ed_ldd rom48k clockTime z80 =
    -- case 0xA8: ldir(-1,false); break;
    z80 |> ldir Backwards False rom48k clockTime


ed_cpd : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
ed_cpd rom48k clockTime z80 =
    -- case 0xA9: cpir(-1,false); break;
    z80 |> cpir Backwards False rom48k clockTime


ed_cpir : Z80ROM -> CpuTimeCTime -> Z80Core -> ( Z80Delta, CpuTimeCTime )
ed_cpir rom48k clockTime z80 =
    -- case 0xB1: cpir(1,true); break;
    z80 |> cpir Forwards True rom48k clockTime
...
inir : DirectionForLDIR -> Bool -> Z80ROM -> CpuTimeCTime -> Z80Core -> Z80IniOuti
inir direction repeat rom48k clockTime z80_core =
    let
        d_original =
            case direction of
                Forwards ->
        ...
        v =
            z80_core.env |> z80_in bc rom48k.keyboard clockTime
...
otir : DirectionForLDIR -> Bool -> Z80ROM -> CpuTimeCTime -> Z80Core -> Z80IniOuti
otir direction repeat rom48k clockTime z80_core =
    let
        hl =
            case direction of
                Forwards ->
        ...
        v =
            z80_core.env |> mem hl clockTime rom48k

        new_bc =
            in_bc - 256 |> Bitwise.and 0xFFFF

        ( env_1, time ) =
            z80_core.env |> z80_out new_bc v.value clockTime
