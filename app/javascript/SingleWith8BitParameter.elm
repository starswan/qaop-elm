...
ld_h_n z80_main param =
    ...
    Bitwise.or (param |> z80ToInt |> shiftLeftBy8) (Bitwise.and z80_main.hl 0xFF) |> NewHLRegisterValue
...
ld_ix_h_n z80_main param =
    ...
    Bitwise.or (param |> z80ToInt |> shiftLeftBy8) (Bitwise.and z80_main.ix 0xFF) |> NewIXRegisterValue


ld_iy_h_n : MainWithIndexRegisters -> Z80Byte -> DoubleWithRegisterChange
ld_iy_h_n z80_main param =
    -- case 0x26: xy=xy&0xFF|imm8()<<8; break;
    Bitwise.or (param |> z80ToInt |> shiftLeftBy8) (Bitwise.and z80_main.iy 0xFF) |> NewIYRegisterValue


ld_l_n : MainWithIndexRegisters -> Z80Byte -> DoubleWithRegisterChange
ld_l_n z80_main param =
    -- case 0x2E: HL=HL&0xFF00|imm8(); break;
    Bitwise.or (param |> z80ToInt) (Bitwise.and z80_main.hl 0xFF00) |> NewHLRegisterValue
...
ld_ix_l_n z80_main param =
    ...
    Bitwise.or (param |> z80ToInt) (Bitwise.and z80_main.ix 0xFF00) |> NewIXRegisterValue


ld_iy_l_n : MainWithIndexRegisters -> Z80Byte -> DoubleWithRegisterChange
ld_iy_l_n z80_main param =
    -- case 0x2E: xy=xy&0xFF00|imm8(); break;
    Bitwise.or (param |> z80ToInt) (Bitwise.and z80_main.iy 0xFF00) |> NewIYRegisterValue
...
add_a_n param z80_flags =
    ...
    let
        ...
        flags =
            z80_flags |> z80_add (param |> z80ToInt)
    in
    --{ z80_1 | flags = flags }
    FlagJump flags
...
sub_n param z80_flags =
    ...
    let
        ...
        flags =
            z80_flags |> z80_sub (param |> z80ToInt)
...
sbc_a_n param z80_flags =
    ...
    z80_flags |> sbc (param |> z80ToInt) |> FlagJump
...
and_n param z80_flags =
    ...
    let
        ...
        flags =
            z80_flags |> z80_and (param |> z80ToInt)
    in
    --{ z80_1 | flags = flags }
...
xor_n param z80_flags =
    ...
    let
        ...
        --z80_1 = { z80 | env = { env_1 | time = v.time }, pc = v.pc }
        flags =
            z80_flags |> z80_xor (param |> z80ToInt)
    in
    --{ z80_1 | flags = flags }
    --FlagsWithPcAndTime flags v.pc v.time
    FlagJump flags
...
or_n param z80_flags =
    ...
    let
        ...
        flags =
            z80_flags |> z80_or (param |> z80ToInt)
    in
    --{ z80_1 | flags = flags }
    --FlagsWithPcAndTime flags a.pc a.time
    FlagJump flags
...
cp_n param z80_flags =
    ...
    let
        ...
        --    imm8 z80.pc z80.env.time rom48k z80.env.ram
        flags =
            z80_flags |> z80_cp (param |> z80ToInt)
