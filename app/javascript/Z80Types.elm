...
call_if : Bool -> Z80ROM -> Z80 -> Z80Env
        ...
        IX ->
            let
                dval =
                    z80.env |> mem z80.env.pc rom48k
            in
            CpuTimePcAndValue (dval.time |> addCpuTimeTime 8) (char (z80.env.pc + 1)) (char (z80.main.ix + byte dval.value))
        ...
        IY ->
            let
                dval =
                    z80.env |> mem z80.env.pc rom48k
            in
            CpuTimePcAndValue (dval.time |> addCpuTimeTime 8) (char (z80.env.pc + 1)) (char (z80.main.iy + byte dval.value))
...
jr rom48k z80 =
    ...
    CpuTimeAndPc (mempc.time |> addCpuTimeTime 8) (Bitwise.and (z80.env.pc + d + 1) 0xFFFF)
