...
applyFlagDelta pcInc duration z80_flags rom48k z80 =
    ...
    case z80_flags of
        ...
        FlagChangeH int ->
            ...
            { z80 | pc = new_pc, env = env_1, r = z80.r + 1, main = { main | hl = { hl | high = int } } }
        ...
        FlagChangeL int ->
            ...
            { z80 | pc = new_pc, env = env_1, r = z80.r + 1, main = { main | hl = { hl | low = int } } }
...
applyShifter : Z80Word -> Shifter -> Z80Word -> CpuTimeCTime -> Z80ROM -> Z80Core -> Z80Core
...
z80_call : Z80Word -> Z80Core -> Z80Core
z80_call addr z80 =
    let
        new_pc =
            --Bitwise.and (z80.pc + 3) 0xFFFF
