...
singleByteMainRegsFD =
    Dict.fromList
        ...
        , ( 0xE5, ( Pushed16BitValue .iy, FifteenTStates ) )
...
singleByteMainRegsDD =
    Dict.fromList
        ...
        , ( 0xE5, ( Pushed16BitValue .ix, FifteenTStates ) )
...
set_iy_h : Int -> MainWithIndexRegisters -> MainWithIndexRegisters
set_iy_h int main =
    { main | iy = Bitwise.or (Bitwise.and main.iy 0xFF) (int |> shiftLeftBy8) }


set_iy_l : Int -> MainWithIndexRegisters -> MainWithIndexRegisters
set_iy_l int main =
    { main | iy = Bitwise.or (Bitwise.and main.iy 0xFF00) int }
