...
import Z80Flags exposing (FlagRegisters, add16, dec, inc, z80_add)
...
ld_h_b z80_main =
    ...
    { changes = ChangeRegisterHL (Bitwise.or (Bitwise.and z80_main.hl 0xFF) (shiftLeftBy8 z80_main.b)), cpu_time = 0 }
...
ld_h_c z80_main =
    ...
    { changes = ChangeRegisterHL (Bitwise.or (Bitwise.and z80_main.hl 0xFF) (shiftLeftBy8 z80_main.c)), cpu_time = 0 }
...
ld_l_b z80_main =
    ...
    { changes = ChangeRegisterHL (Bitwise.or (Bitwise.and z80_main.hl 0xFF00) z80_main.b), cpu_time = 0 }
...
ld_l_c z80_main =
    ...
    { changes = ChangeRegisterHL (Bitwise.or (Bitwise.and z80_main.hl 0xFF00) z80_main.c), cpu_time = 0 }
...
ld_l_d z80_main =
    ...
    { changes = ChangeRegisterHL (Bitwise.or (Bitwise.and z80_main.hl 0xFF00) z80_main.d), cpu_time = 0 }
...
ld_l_e z80_main =
    ...
    { changes = ChangeRegisterHL (Bitwise.or (Bitwise.and z80_main.hl 0xFF00) z80_main.e), cpu_time = 0 }
...
ld_a_b z80_main =
    ...
    { changes = ChangeRegisterA z80_main.b, cpu_time = 0 }
...
ld_a_c z80_main =
    ...
    { changes = ChangeRegisterA z80_main.c, cpu_time = 0 }
...
ld_a_d z80_main =
    ...
    { changes = ChangeRegisterA z80_main.d, cpu_time = 0 }
...
ld_a_e z80_main =
    ...
    { changes = ChangeRegisterA z80_main.e, cpu_time = 0 }
...
ld_a_h z80_main =
    ...
    { changes = ChangeRegisterA (shiftRightBy8 z80_main.hl), cpu_time = 0 }
...
add_a_b z80_main z80_flags =
    ...
    { changes = Z80ChangeFlags (z80_add z80_main.b z80_flags), cpu_time = 0 }
...
add_a_c z80_main z80_flags =
    ...
    { changes = Z80ChangeFlags (z80_add z80_main.c z80_flags), cpu_time = 0 }
...
add_a_d z80_main z80_flags =
    ...
    { changes = Z80ChangeFlags (z80_add z80_main.d z80_flags), cpu_time = 0 }
...
add_a_e z80_main z80_flags =
    ...
    { changes = Z80ChangeFlags (z80_add z80_main.e z80_flags), cpu_time = 0 }
...
add_a_h z80_main z80_flags =
    ...
    { changes = Z80ChangeFlags (z80_add (shiftRightBy8 z80_main.hl) z80_flags), cpu_time = 0 }
...
add_a_l z80_main z80_flags =
    ...
    { changes = Z80ChangeFlags (z80_add (Bitwise.and z80_main.hl 0xFF) z80_flags), cpu_time = 0 }
