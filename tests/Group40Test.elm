                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xDD
                                |> setMemIgnoringTime (addr + 1) 0x45
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xDD
                                |> setMemIgnoringTime (addr + 1) 0x46
