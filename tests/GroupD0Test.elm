                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 1, d = 0x56, e = 0x16, sp = 0xFF79 } { sp = new_z80.env.sp, pc = new_pc, d = new_z80.main.d, e = new_z80.main.e }
            ]
                ...
                let
                    ...
                    ( new_z80, new_pc ) =
                        executeCoreInstruction z80rom
                            ...
                            |> Triple.dropSecond
                in
                Expect.equal { pc = 0x10, sp = 0xFF75 } { sp = new_z80.env.sp, pc = new_pc }
                ...
                let
                    ...
                    ( new_z80, new_pc ) =
                        executeCoreInstruction z80rom
                            ...
                            |> Triple.dropSecond
                in
                Expect.equal ( addr + 2, 0xFF ) ( new_pc, new_z80.flags.a )
        ...
        , test "0xDF RST 18" <|
            \_ ->
                let
                    ...
                    lo_value =
                        getMem8 0xFF75 clock.clockTime z80rom.z80rom new_z80.env |> Tuple.first

                    hi_value =
                        getMem8 0xFF76 clock.clockTime z80rom.z80rom new_z80.env |> Tuple.first
                in
