                ...
                let
                    ...
                    ( new_z80, new_pc ) =
                        executeCoreInstruction z80rom
                            ...
                            |> Triple.dropSecond
                in
                Expect.equal ( addr + 2, 0x04 ) ( new_pc, new_z80.main.b )
        , test "0xDD 0xCB nn 0xD6 SET 2, (IX + n)" <|
            \_ ->
                let
                    ...
                    mem_value =
                        new_z80.env |> getMem8 0xA086 clock.clockTime z80rom.z80rom |> Tuple.first
                in
                Expect.equal ( addr + 4, 0x04 ) ( new_pc, mem_value )
                ...
                let
                    ...
                    ( new_z80, new_pc ) =
                        executeCoreInstruction z80rom
                            ...
                            |> Triple.dropSecond
                in
                Expect.equal ( addr + 2, 0x08 ) ( new_pc, new_z80.main.b )
        ]
