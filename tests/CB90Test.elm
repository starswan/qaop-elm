    ...
    describe "Bit instructions (CB)"
        [ test "0xCB 90 RES 2,B" <|
            \_ ->
                ...
                in
                Expect.equal ( int_addr + 2, 0xFB ) ( new_z80.pc|> toInt, new_z80.main.b )
        , test "0xCB 98 RES 3,B" <|
            \_ ->
                ...
                in
                Expect.equal ( int_addr + 2, 0xF7 ) ( new_z80.pc|> toInt, new_z80.main.b )
