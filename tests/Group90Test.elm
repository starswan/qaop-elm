        ...
        [ describe "0x94 SUB H"
            [ test "SUB H" <|
                \_ ->
                    ...
                    in
                    Expect.equal { pc = addr + 1, a = 0x26 } { pc = new_z80.pc, a = new_z80.flags.a }
            , test "SUB IXH" <|
                \_ ->
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0x94
                    ...
                    in
                    Expect.equal { pc = addr + 2, a = 0x26 } { pc = new_z80.pc, a = new_z80.flags.a }
            , test "SUB IYH" <|
                \_ ->
                    let
                        new_env =
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xDD
                                |> setMemIgnoringTime (addr + 1) 0x95
                    ...
                    in
                    Expect.equal { pc = addr + 2, a = 0x24 } { pc = new_z80.pc, a = new_z80.flags.a }
            , test "SUB IYL" <|
                \_ ->
                    let
                        new_env =
            ...
            [ test "SUB (HL)" <|
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0x96
                                |> setMemIgnoringTime 0x5050 0x11
                    ...
                    in
                    Expect.equal { pc = addr + 1, a = 0x65 } { pc = new_z80.pc, a = new_z80.flags.a }
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xDD
                                |> setMemIgnoringTime (addr + 1) 0x96
                                |> setMemIgnoringTime (addr + 2) 0xFF
                                |> setMemIgnoringTime 0x5051 0x11
                    ...
                    in
                    Expect.equal { pc = addr + 3, a = 0x65 } { pc = new_z80.pc, a = new_z80.flags.a }
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xDD
                                |> setMemIgnoringTime (addr + 1) 0x9C
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xDD
                                |> setMemIgnoringTime (addr + 1) 0x9D
        ...
        , describe "0x9E SBC (HL)"
            [ test "SBC (HL)" <|
                \_ ->
                    ...
                    in
                    Expect.equal { pc = addr + 1, a = 0x64 } { pc = new_z80.pc, a = new_z80.flags.a }
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xDD
                                |> setMemIgnoringTime (addr + 1) 0x9E
                                |> setMemIgnoringTime (addr + 2) 0xFF
                                |> setMemIgnoringTime 0x5051 0x11
                    ...
                    in
                    Expect.equal { pc = addr + 3, a = 0x64 } { pc = new_z80.pc, a = new_z80.flags.a }
