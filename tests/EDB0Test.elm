            ...
            [ test "LDIR ED B0" <|
                \_ ->
                    let
                        ...
                        mem_vals =
                            [ getMem8 0x6000 clock.clockTime z80rom.z80rom new_z80.env |> Tuple.first
                            , getMem8 0x6001 clock.clockTime z80rom.z80rom new_z80.env |> Tuple.first
                            , getMem8 0x6002 clock.clockTime z80rom.z80rom new_z80.env |> Tuple.first
                            , getMem8 0x6003 clock.clockTime z80rom.z80rom new_z80.env |> Tuple.first
                            , getMem8 0x6004 clock.clockTime z80rom.z80rom new_z80.env |> Tuple.first
                            ]
                    in
