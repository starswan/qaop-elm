...
suite =
    let
        ...
        z80 =
            { old_z80 | pc = addr, env = { old_z80env | sp = sp }, main = { z80main | hl = hl, b = 0x35, c = 0xFD, d = 0x6F, e = 0x57 } }
        ...
        [ describe "SLA B"
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0x20
            ...
            , test "0xDD 0xCB d 0x20 SLA (IX + d), B" <|
                \_ ->
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 3) 0x20
                    ...
                    in
                    Expect.equal ( addr + 4, 0xA0, 0xA0 ) ( new_z80.pc, new_z80.main.b, mem_value.value )
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x21
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x21
                                |> setMemIgnoringTime 0x6545 0x50
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 new_z80.env.time z80rom
                    in
                    Expect.equal ( addr + 4, 0xA0, 0xA0 ) ( new_z80.pc, new_z80.main.c, mem_value.value )
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x22
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x22
                                |> setMemIgnoringTime 0x6545 0x50
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 new_z80.env.time z80rom
                    in
                    Expect.equal ( addr + 4, 0xA0, 0xA0 ) ( new_z80.pc, new_z80.main.d, mem_value.value )
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x23
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x23
                                |> setMemIgnoringTime 0x6545 0x50
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 new_z80.env.time z80rom
                    in
                    Expect.equal ( addr + 4, 0xA0, 0xA0 ) ( new_z80.pc, new_z80.main.e, mem_value.value )
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x24
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x24
                                |> setMemIgnoringTime 0x6545 0x50
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 new_z80.env.time z80rom
                    in
                    Expect.equal ( addr + 4, 0xA050, 0xA0 ) ( new_z80.pc, new_z80.main.hl, mem_value.value )
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x25
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x25
                                |> setMemIgnoringTime 0x6545 0x50
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 new_z80.env.time z80rom
                    in
                    Expect.equal ( addr + 4, 0x50A0, 0xA0 ) ( new_z80.pc, new_z80.main.hl, mem_value.value )
            ...
            \_ ->
                let
                    new_env =
                        z80env
                            |> setMemIgnoringTime addr 0xCB
                            |> setMemIgnoringTime (addr + 1) 0x26
                            |> setMemIgnoringTime 0x6545 0x31
                ...
                let
                    new_env =
                        z80env
                            ...
                            |> setMemIgnoringTime (addr + 1) 0xCB
                            |> setMemIgnoringTime (addr + 2) 0x45
                            |> setMemIgnoringTime (addr + 3) 0x26
                            |> setMemIgnoringTime 0x6545 0x31
            ...
            \_ ->
                let
                    new_env =
                        z80env
                            |> setMemIgnoringTime addr 0xCB
                            |> setMemIgnoringTime (addr + 1) 0x27
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x28
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x28
                                |> setMemIgnoringTime 0x6545 0x50
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x29
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x29
                                |> setMemIgnoringTime 0x6545 0x50
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x2A
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x2A
                                |> setMemIgnoringTime 0x6545 0x50
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x2B
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x2B
                                |> setMemIgnoringTime 0x6545 0x50
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x2C
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x2C
                                |> setMemIgnoringTime 0x6545 0x50
                ...
                \_ ->
                    let
                        new_env =
                            z80env
                                |> setMemIgnoringTime addr 0xCB
                                |> setMemIgnoringTime (addr + 1) 0x2D
                    ...
                    let
                        new_env =
                            z80env
                                ...
                                |> setMemIgnoringTime (addr + 1) 0xCB
                                |> setMemIgnoringTime (addr + 2) 0x45
                                |> setMemIgnoringTime (addr + 3) 0x2D
                                |> setMemIgnoringTime 0x6545 0x50
            ...
            \_ ->
                let
                    new_env =
                        z80env
                            |> setMemIgnoringTime addr 0xCB
                            |> setMemIgnoringTime (addr + 1) 0x2E
                            |> setMemIgnoringTime 0x6545 0x50
                ...
                let
                    new_env =
                        z80env
                            ...
                            |> setMemIgnoringTime (addr + 1) 0xCB
                            |> setMemIgnoringTime (addr + 2) 0x45
                            |> setMemIgnoringTime (addr + 3) 0x2E
                            |> setMemIgnoringTime 0x6545 0x50
            ...
            \_ ->
                let
                    new_env =
                        z80env
                            |> setMemIgnoringTime addr 0xCB
                            |> setMemIgnoringTime (addr + 1) 0x2F
