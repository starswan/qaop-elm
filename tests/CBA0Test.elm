    ...
    describe "Bit instructions (CB)"
        [ test "0xCB A0 RES 4,B" <|
            \_ ->
                let
                    new_env =
                        z80env
                            |> setMem (z80_addr) 0xCB
                            |> setMem (z80_addr |> incrementBy1) 0xA0
                ...
                in
                Expect.equal ( addr + 2, 0xEF ) ( new_z80.pc|> toInt, new_z80.main.b )
            ...
            \_ ->
                let
                    new_env =
                        z80env
                            |> setMem (z80_addr) 0xCB
                            |> setMem (z80_addr |> incrementBy1) 0xA8
                ...
                in
                Expect.equal ( addr + 2, 0xDF ) ( new_z80.pc|> toInt, new_z80.main.b )
        , test "0xFD 0xCB nn 0xAE RES 5, (IY + n) -ve" <|
            \_ ->
                let
                    new_env =
                        z80env
                            ...
                            |> setMem (z80_addr |> incrementBy3) 0xAE
                ...
                in
                Expect.equal ( addr + 4, 0xDF ) ( new_z80.pc|> toInt, mem_value.value )
        ]
