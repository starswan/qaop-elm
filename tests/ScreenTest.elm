...
import SpectrumColour exposing (InkPaperColour(..), brightGreen, brightMagenta, plainBlack, plainBlue, plainGreen, plainMagenta, plainWhite)
import Test exposing (..)
import Z80Screen exposing (getScreenValue, screenLines, setScreenValue)
    ...
    describe "screen"
        [ describe "rawToLines"
            [ only <|
                ...
                , only <| test "set first 2 top left corners" <|
                    \_ ->
                        let
                            -- colour is Ink 1 (bits 0-2) Paper 2 (bits 5-3) 1 dot, 7 blanks + 7 blanks, 1 dot
                            a =
