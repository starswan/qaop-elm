        ...
        [ describe "0x20 - JR NZ,n"
            [ test "Dont jump" <|
                \_ ->
                    ...
                    in
                    Expect.equal ( addr + 2, 7 ) ( new_z80.pc, new_z80.clockTime.cpu_time - z80.clockTime.cpu_time )
            , test "forwards" <|
                \_ ->
                    let
                        new_env =
                    ...
                    in
                    Expect.equal ( addr + 7, 12 ) ( new_z80.pc, new_z80.clockTime.cpu_time - z80.clockTime.cpu_time )
            , test "backwards" <|
                \_ ->
                    let
                        new_env =
            ...
            [ test "0x22 LD (nn), HL" <|
                \_ ->
                    let
                        ...
                        lo_value =
                            new_z80.env |> mem 0x5577 z80.clockTime z80rom.z80rom

                        high_value =
                            new_z80.env |> mem 0x5578 z80.clockTime z80rom.z80rom
                    in
