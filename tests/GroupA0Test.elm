                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 1, a = 0x01 } { pc = new_pc, a = new_z80.flags.a }
            , test "AND IXH" <|
                \_ ->
                    let
                        new_env =
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 2, a = 0x01 } { pc = new_pc, a = new_z80.flags.a }
            , test "AND IYH" <|
                \_ ->
                    let
                        new_env =
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 1, a = 0x50 } { pc = new_pc, a = new_z80.flags.a }
            , test "SUB IXL" <|
                \_ ->
                    let
                        new_env =
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 2, a = 0x50 } { pc = new_pc, a = new_z80.flags.a }
            , test "AND IYL" <|
                \_ ->
                    let
                        new_env =
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 1, a = 0x10 } { pc = new_pc, a = new_z80.flags.a }
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 3, a = 0x10 } { pc = new_pc, a = new_z80.flags.a }
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 1, a = 0xC0 } { pc = new_pc, a = new_z80.flags.a }
            , test "XOR IXH" <|
                \_ ->
                    let
                        new_env =
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 2, a = 0xC0 } { pc = new_pc, a = new_z80.flags.a }
            , test "XOR IYH" <|
                \_ ->
                    let
                        new_env =
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 1, a = 0x67 } { pc = new_pc, a = new_z80.flags.a }
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal { pc = addr + 3, a = 0x67 } { pc = new_pc, a = new_z80.flags.a }
