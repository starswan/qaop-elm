        ...
        [ describe "SLL B"
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal ( addr + 2, 0xA1 ) ( new_pc, new_z80.main.b )
            , test "0xDD 0xCB d 0x30 SLL (IX + d), B" <|
                \_ ->
                    ...
                    in
                    Expect.equal ( addr + 4, 0xA1, 0xA1 ) ( new_pc, new_z80.main.b, mem_value.value )
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal ( addr + 2, 0xA1 ) ( new_pc, new_z80.main.c )
                ...
                \_ ->
                    let
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 clock.clockTime z80rom
                    in
                    Expect.equal ( addr + 4, 0xA1, 0xA1 ) ( new_pc, new_z80.main.c, mem_value.value )
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal ( addr + 2, 0xA1 ) ( new_pc, new_z80.main.d )
                ...
                \_ ->
                    let
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 clock.clockTime z80rom
                    in
                    Expect.equal ( addr + 4, 0xA1, 0xA1 ) ( new_pc, new_z80.main.d, mem_value.value )
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal ( addr + 2, 0xA1 ) ( new_pc, new_z80.main.e )
                ...
                \_ ->
                    let
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 clock.clockTime z80rom
                    in
                    Expect.equal ( addr + 4, 0xA1, 0xA1 ) ( new_pc, new_z80.main.e, mem_value.value )
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal ( addr + 2, 0xA145 ) ( new_pc, new_z80.main.hl )
                ...
                \_ ->
                    let
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 clock.clockTime z80rom
                    in
                    Expect.equal ( addr + 4, 0xA150, 0xA1 ) ( new_pc, new_z80.main.hl, mem_value.value )
                    ...
                    let
                        ...
                        ( new_z80, new_pc ) =
                            executeCoreInstruction z80rom
                                ...
                                |> Triple.dropSecond
                    in
                    Expect.equal ( addr + 2, 0x50A1 ) ( new_pc, new_z80.main.hl )
                ...
                \_ ->
                    let
                        ...
                        mem_value =
                            new_z80.env |> mem 0x6545 clock.clockTime z80rom
                    in
                    Expect.equal ( addr + 4, 0x50A1, 0xA1 ) ( new_pc, new_z80.main.hl, mem_value.value )
            ...
            \_ ->
                let
                    ...
                    mem_value =
                        new_z80.env |> mem 0x6545 clock.clockTime z80rom
                in
                Expect.equal ( addr + 2, 0x63 ) ( new_pc, mem_value.value )
            ...
            \_ ->
                let
                    ...
                    mem_value =
                        new_z80.env |> mem 0x6545 clock.clockTime z80rom
                in
                Expect.equal ( addr + 4, 0x63 ) ( new_pc, mem_value.value )
                ...
                let
                    ...
                    ( new_z80, new_pc ) =
                        executeCoreInstruction z80rom
                            ...
                            |> Triple.dropSecond
                in
                Expect.equal ( addr + 2, 0x61 ) ( new_pc, new_z80.flags.a )
        , describe "SRL B"
