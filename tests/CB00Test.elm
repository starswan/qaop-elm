            ...
            , test "0xDD 0xCB d 0x00 RLC (IX + d), B" <|
                \_ ->
                    let
                        ...
                        mem_value =
                            new_z80.env |> getMem8 0x6545 clock.clockTime z80rom.z80rom |> Tuple.first
                    in
            ...
            [ test "0x31" <|
                \_ ->
                    let
                        ...
                        mem_value =
                            new_z80.env |> getMem8 hl clock.clockTime z80rom.z80rom |> Tuple.first
                    in
            ...
            , test "0xFD 0xCB 0x06 0x45 RLC (IY - d)" <|
                \_ ->
                    let
                        ...
                        mem_value =
                            new_z80.env |> getMem8 0x6500 clock.clockTime z80rom.z80rom |> Tuple.first
                    in
                    Expect.equal ( addr + 4, 0x62, 0x20 ) ( new_pc, mem_value, new_z80.flags |> getFlags )
            ]
